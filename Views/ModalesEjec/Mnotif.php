  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content" style="width: 127%;">
      <div class="modal-body">
        ...
        <form id="formagrnotif" class="row g-3">
          <div class="col-sm-6 SMData">
            <label for="cltagrnot" class="form-label">Cliente</label>  
            <input class="form-control" autocomplete="off" role="combobox" list="" id="cltagrnot">
            <input type="hidden" id="cltagrnot1">

            <datalist id="dtlcltargnot" role="listbox" class="dtl2">
